...
| 날짜 | 커밋 | 변경 요약 |
| 2026-08-25 | pending | **옵저버 노드 상한 11→8 축소** — 무트래픽 상태에서 새 시작 프로필이 Managed1+default6+stress4 총11대까지 확장한 것을 확인. user control point를 보존하며 `200m@12%·max48`→`150m@15%·max32`, warm12→8, stress max12→8로 조정하고 NodePool ceiling을 default4대+stress3대로 낮춰 총 최대8대, 유휴 시 2~4대까지 consolidation 가능하도록 변경 |
