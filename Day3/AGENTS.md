...
| 2026-08-25 | pending | **observer stress 과밀 방지 2-Pod/Node 프로필** — 공식 0.5x 재시험(run-1787609593)에서 `400m` stress 4개가 t3.medium 한 대에 배치된 뒤 실사용 2.6~3코어·P95 17.3초 backlog가 발생해 4분 36.5/40(stress 75.86%, avg2.25)로 하락한 실측 반영. stress를 `600m@55%`(absolute 330m), baseline/warm 2, pressure 4, max 8로 조정해 allocatable 1930m에서 daemon overhead 포함 노드당 정확히 2 Pod만 허용. PS7/PS5 self-test 22/22 및 live rollout/HPA 검증. |
